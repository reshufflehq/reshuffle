...
> Snapshot 1
    ...
    {
      err: ` ›   Error: --app-name= cannot also be provided when using --new-app=␊
      `,
      exitCode: 2,
      out: '',
    }
...
> Snapshot 1
    ...
    {
      err: `␊
      > poll@ build /private/var/folders/xd/62n2zksd32jdwdtc3l9nz1bh0000gn/T/dot-reshuffle-MGkxmJ/project␊
      > echo nothing to do␊
      ␊
      nothing to do␊
      built␊
      `,
      exitCode: 0,
      out: `{"accountId":"127001","createdAt":"1999-12-31T23:59:59.999Z","updatedAt":"1999-12-31T23:59:59.999Z","id":"abc","name":"fluffy-pancake-66","locked":false,"environments":[{"name":"default","domains":[{"type":"subdomain","name":"a.b.c"}]}],"primaryURL":"https://a.b.c"}␊
      `,
    }
